    ...
    return (
        <div className="flex flex-col sm:flex-row sm:justify-between gap-6 mt-8 mx-8 mb-12 self-start sm:mx-10 items-center">
            <div className="flex flex-row ">
                <input type="text" placeholder="Search Speakers.." className="w-full bg-zinc-900 border border-zinc-700 text-white rounded full py-3 pl-2 pr-12 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 transtion-all placeholder:text-zinc-500" />
            ...
            <div>
                <select className="w-full bg-zinc-900 border border-zinc-700 text-white rounded py-3 pl-2 pr-12 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 cursor-pointer">
